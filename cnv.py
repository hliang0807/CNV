...
class MainContent(ScrollArea):
    ...
    def setLabels(self):
        ...
        self.right_lable2 = QPushButton("最低外显子长度")
        ...
        self.right_lable5 = QPushButton("最低reads count")
        ...
        self.right_lable7 = QPushButton("js散度阈值")
        ...
        self.right_line7.setPlaceholderText("0.9(default)")
        self.right_line7.setValidator(QtGui.QDoubleValidator())
